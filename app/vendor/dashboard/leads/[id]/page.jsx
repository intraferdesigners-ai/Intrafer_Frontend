        ...
        <div className="lead-detail-layout">
          ...
          <div>
            ...
            <div className="form-row" style={{ gap: '14px 24px', marginBottom: 24 }}>
              ...
              <DetailItem icon={User}     label="Client name" value={lead.contactName}       />
            </div>
            ...
            <div>
              ...
              {!isContactRevealed ? (
                ...
                <div style={{
                  ...
                  {[
                    { icon: User,  value: lead.contactName,  href: null,                            weight: 500, size: 15 },
                    { icon: Phone, value: lead.contactPhone, href: `tel:${lead.contactPhone}`,       weight: 400, size: 14 },
                    { icon: Mail,  value: lead.contactEmail, href: `mailto:${lead.contactEmail}`,    weight: 400, size: 14 },
                  ...
                  {lead.contactPhone && (
                    <a
                      href={`https://wa.me/91${lead.contactPhone}?text=${waMessage}`}
                      target="_blank"
                    ...
                    >
                      ...
                      Message {lead.contactName?.split(' ')[0] || 'client'} on WhatsApp
                    </a>
                  )}
                </div>
              )}
