...
function EnquiryForm() {
  ...
  return (
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      {/* Decorative background: dot grid + soft blurred shapes — subtle,
      ...
      <div style={{
        ...
        maxWidth: '960px', margin: 'clamp(80px,10vw,108px) auto 60px',
        ...
        <div className="enquiry-split-card" style={{
          ...
          {/* ── RIGHT PANEL — form ── */}
          <div style={{ padding: 'clamp(20px, 6vw, 40px)' }}>
