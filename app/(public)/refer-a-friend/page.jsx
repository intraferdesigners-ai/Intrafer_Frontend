// DISABLED 2026-07-21: this page promised specific monetary referral rewards
// (₹2,000 referrer credit, ₹1,000 friend discount, 12-month redemption
// window) with zero backend support — no Referral model, no crediting or
// redemption logic anywhere in Intrafer_Backend — and its "referral code"
// was just Math.random() regenerated fresh on every page load, never
// persisted. Not linked from navbar/footer/anywhere else in the app
// (confirmed via repo-wide grep for "refer-a-friend").
//
// To restore: either (a) build the real backend first — a Referral model,
// code generation/persistence tied to the user, and crediting/redemption
// logic wired into the lead-acceptance flow — then bring back the commented
// component below, or (b) redesign this into a simple lead-capture form
// ("tell us who to refer") with no reward promises until (a) exists.
//
